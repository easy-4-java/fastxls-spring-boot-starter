...
/**
 * Unit tests for {{ @link FastxlsPOIAutoConfiguration }}.
 *
 ...
 * @since 1.0.0
 */
@DisplayName("FastxlsPOIAutoConfiguration Tests")
class FastxlsPOIAutoConfigurationTest {
    ...
    void testInstantiation() {
        FastxlsPOIAutoConfiguration configuration = new FastxlsPOIAutoConfiguration();
